...
(select
  ...
  case when profile_details.profile_group%10000=1 then 'LITTLE_KIDS'
       when profile_details.profile_group%10000=10 then 'OLDER_KIDS'
       when profile_details.profile_group%10000=11 then 'OLDER_KIDS-LITTLE_KIDS'
       when profile_details.profile_group%10000=100 then 'TEENS'
       when profile_details.profile_group%10000=101 then 'TEENS-LITTLE_KIDS'
       when profile_details.profile_group%10000=110 then 'TEENS-OLDER_KIDS'
       when profile_details.profile_group%10000=111 then 'TEENS-OLDER_KIDS-LITTLE_KIDS'
       when profile_details.profile_group%10000=1000 then 'ADULTS'
       when profile_details.profile_group%10000=1001 then 'ADULTS-LITTLE_KIDS'
       when profile_details.profile_group%10000=1010 then 'ADULTS-OLDER_KIDS'
       when profile_details.profile_group%10000=1011 then 'ADULTS-OLDER_KIDS-LITTLE_KIDS'
       when profile_details.profile_group%10000=1100 then 'ADULTS-TEENS'
       when profile_details.profile_group%10000=1101 then 'ADULTS-TEENS-LITTLE_KIDS'
       when profile_details.profile_group%10000=1110 then 'ADULTS-TEENS-OLDER_KIDS'
       when profile_details.profile_group%10000=1111 then 'ADULTS-TEENS-OLDER_KIDS-LITTLE_KIDS'
       end as profile_grp2,
...
group by account_id
having sum(a.profile_group_tmp)>0) profile_details
